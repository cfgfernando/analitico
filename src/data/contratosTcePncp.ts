  ...
  return [
    {
      ...
      pctExecutado: 50.0,
      criticidade: 'ALTA',
      criticidadeFonte: 'TCE-PR / PNCP',
      impactoMunicipal: 'Atenção Básica à Saúde',
    ...
    },
    {
      ...
      criticidade: 'ALTA',
      criticidadeFonte: 'TCE-PR / PNCP',
      impactoMunicipal: 'Alimentação Escolar da Rede Pública',
    ...
    },
    {
      ...
      criticidade: 'MÉDIA',
      criticidadeFonte: 'PNCP Oficial',
      impactoMunicipal: 'Segurança Patrimonial dos Próprios Públicos',
    ...
    },
    {
      ...
      criticidade: 'MÉDIA',
      criticidadeFonte: 'PNCP Oficial',
      impactoMunicipal: 'Higienização e Conservação Predial',
    ...
    },
    {
      ...
      criticidade: 'ALTA',
      criticidadeFonte: 'TCE-PR / PNCP',
      impactoMunicipal: 'Infraestrutura Urbana e Pavimentação',
