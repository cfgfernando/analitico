...
export const MUNICIPIOS_REFERENCIA: MunicipioBase[] = [
  ...
  },
  {
    ...
    mesorregiao: 'Metropolitana de Curitiba',
    ddd: '41',
    emailFaturamento: 'financas@contenda.pr.gov.br',
    telefoneContato: '(41) 3625-1212',
    websiteOficial: 'https://contenda.pr.gov.br',
    prefeitoNome: 'Antônio Adamir Digner',
    prefeitoEmail: 'gabinete@contenda.pr.gov.br',
    secFinancasNome: 'Secretaria Municipal de Finanças de Contenda',
    secFinancasEmail: 'financas@contenda.pr.gov.br',
  },
  {
    codigoIbge: '4106902',
    cidade: 'Curitiba',
